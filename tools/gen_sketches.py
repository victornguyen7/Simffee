...
# Each lever: id, tags, setup needs, s1 (sign of the primary move), s2 (sign of the secondary move),
...
LEVERS = [
    ...
    dict(id="open_later", tags=["hours", "opening", "later", "9am", "10am", "sleep in"],
         ...
         secondary="{m} of them keep the new habit even after you reopen early",
         secondary0="they come back the day you reopen early",
    ...
    dict(id="add_lunch", tags=["product", "lunch", "sandwich", "sandwiches", "bowls", "salad", "noon"],
         setup=["product:sandwich"], s1=+1, s2=0,
         headline="A lunch menu makes {shop} a second daily stop for {seg}",
         primary="{n} {seg} add a noon visit on top of their morning coffee",
    ...
    dict(id="rival_promo", tags=["competitor", "rival", "promotion", "promo", "two-for-one", "deal", "their discount"],
         ...
         primary="{n} {seg} go to {rival} while the deal lasts",
         secondary="{m} of them keep going after it ends",
         secondary0="they drift back to {shop} the day the deal ends",
    ...
    dict(id="revert", tags=["revert", "back", "undo", "original", "before", "was", "used to"],
         ...
         secondary="{m} of them have settled at {rival} by now and stay there",
